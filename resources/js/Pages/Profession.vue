<script>
    ...
    <template>
        <Head title="Profession Lists" />
        <BreezeAuthenticatedLayout>

  <div class="px-4 sm:px-6 lg:px-8" v-if="datas">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-xl font-semibold text-gray-900">Profession</h1>
...
<!-- 
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr v-for="(profession,key) in professions" :key="profession.id">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{ key+1 }}</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ profession.name }}</td>

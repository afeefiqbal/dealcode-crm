      ...
      <table class="min-w-full divide-y divide-gray-300">
        <thead>
          <tr>
            ...
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Message</th>
...
import { Head, Link, usePage, usePageProps} from '@inertiajs/inertia-vue3';
import { Inertia } from '@inertiajs/inertia';
const contact = usePage().props.value.contact;

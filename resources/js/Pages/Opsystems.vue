...
<template>
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-xl font-semibold text-gray-900">Op Systems</h1>
  ...
  <script setup>
    ...
    const people = usePage().props.value.opsystems;
    const file = ref(null);
    ...
    function saveData(){
        ...
        Inertia.post(route('import_opsystems', formData), formData, {
            preserveState: true,
            onSuccess: () => {
                isOpen.value = false;
            },

...
<template>
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-xl font-semibold text-gray-900">Facebook Groups</h1>
      ...
      >
        <div class="max-w-2xl p-6 bg-white rounded-md shadow-xl">
          <div class="flex items-center justify-between">
            <h3 class="text-2xl">Add Facebook Groups</h3>
          ...
          <div class="mt-4">
            ...
            <div class="justify-between">
              ...
              <input  type="text" v-model="formData.group_name" class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
            </div>
            <div class="justify-between">
  ...
  <script setup>
    ...
    const people = usePage().props.value.groups;
    const file = ref(null);
    ...
    function saveData(){
        ...
        Inertia.post(route('import_facebook_groups', formData), formData, {
            preserveState: true,
            onSuccess: () => {
                isOpen.value = false;
                  setTimeout(() => {
                        Inertia.visit('facebook_groups', { preserveScroll: true });
                    }, 1000);
            },
        });
    }
    function deleteData(ids) {
        ...
        Swal.fire({
            ...
            if (result.value) {
               Inertia.get(route('delete_facebook_groups', {id: ids}));
               Swal.fire({
                title: 'Success',
